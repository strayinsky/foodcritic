...
SECRET_KEY = 'oe_v46b_n^_q)y&f_fu*_24b%3dvo@4)8t&ep%ko@7b!ln*k3u'
...
ROOT_URLCONF = 'foodcritic.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'foodcritic.wsgi.application'
...
INSTALLED_APPS = (
    ...
    #put this in to do migrations for allauth
    'south',
