...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'food_restaurant', (
        ...
        db.send_create_signal(u'food', ['Restaurant'])

        # Adding model 'Dish'
        db.create_table(u'food_dish', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Restaurant'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'food', ['Dish'])

        # Adding model 'Grade'
        db.create_table(u'food_grade', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'food', ['Grade'])


    def backwards(self, orm):
        # Deleting model 'Restaurant'
        db.delete_table(u'food_restaurant')

        # Deleting model 'Dish'
        db.delete_table(u'food_dish')

        # Deleting model 'Grade'
        db.delete_table(u'food_grade')
    ...
    models = {
        ...
        u'food.dish': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['food.Restaurant']"}),
        ...
        u'food.grade': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'dish': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['food.Dish']"}),
